...
$cached = false;
t3lib_extMgm::addPItoST43( $_EXTKEY, 'pi2/class.tx_radialsearch_pi1.php', '_pi2', 'list_type', $cached );

$cached = false;
t3lib_extMgm::addPItoST43( $_EXTKEY, 'pi1/class.tx_radialsearch_pi3.php', '_pi3', 'list_type', $cached );
