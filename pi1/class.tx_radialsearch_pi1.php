  ...
  private function initTemplate()
  {
    ...
    if (empty($template))
    {
      $prompt = '<h1>'
              ...
              . '<ul>'
              . '  <li>'
              . '    Did you include the static template of Radial Search?'
              . '  </li>'
              . '  <li>'
              . '    Did you include the static template above the static template of the Browser - TYPO3 without PHP (browser)?'
              . '  </li>'
              . '</ul>'
              ...
              . '<ul>'
              . '  <li>'
              . '    Include the static template of Radial Search.'
              . '  </li>'
              . '  <li>'
              . '    Remove the RADIALSEARCH filter from the Browser - TYPO3 without PHP (browser) - template.<br />'
              . '    See: plugin.tx_browser_pi1.views.list.[id].filter'
              . '  </li>'
              . '</ul>'
              . '<p>'
