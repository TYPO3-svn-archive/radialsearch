 ...
 *
 *
 *   55: class tx_radialsearch_pi2_flexform
 *   87:     function main()
 *
 *              SECTION: Sheets
...
/**
 * Class tx_radialsearch_pi2_flexform is an image of the values of the plugin 1 flexform
 *
 ...
 * @since   0.0.1
 */
class tx_radialsearch_pi2_flexform
{
    // Parent object
  private $pObj = null;
    // Current row
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/radialsearch/pi2/class.tx_radialsearch_pi2_flexform.php']) {
  include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/radialsearch/pi2/class.tx_radialsearch_pi2_flexform.php']);
}
?>